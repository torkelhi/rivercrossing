...
func MoveTo(MoveTo string) string {
	...
	if MoveTo == "HS og kylling til Vest" {
		Status = HsState[0]
		fmt.Println(HsState[0] + "Init State")
		return HsState[0]
	}

	if MoveTo == "HS og kylling til båt" && Status == HsState[0] {
		Status = HsState[1]
		fmt.Println(HsState[1])
		return HsState[1]
	}

	if MoveTo == "HS og kylling til båt" && Status == HsState[2] {
		Status = HsState[1]
		fmt.Println(HsState[1])
		return HsState[1]
	}

	if MoveTo == "HS og kylling til Øst" && Status == HsState[1] {
		Status = HsState[2]
		fmt.Println(HsState[2])
		return HsState[2]
	}
	if MoveTo == "HS og kylling til Øst" && Status == HsState[3] {
		Status = HsState[2]
		fmt.Println(HsState[2])
		return HsState[2]
	}
	if MoveTo == "HS til båt" && Status == HsState[2] {
		Status = HsState[3]
		fmt.Println(HsState[3])
		return HsState[3]
	}
	if MoveTo == "HS til båt" && Status == HsState[4] {
		Status = HsState[3]
		fmt.Println(HsState[3])
		return HsState[3]
	}
	if MoveTo == "HS til Vest" && Status == HsState[3] {
		Status = HsState[4]
		fmt.Println(HsState[4])
		return HsState[4]
	}
	if MoveTo == "HS til Vest" && Status == HsState[5] {
		Status = HsState[4]
		fmt.Println(HsState[4])
		return HsState[4]
	}
	if MoveTo == "HS og korn til båt" && Status == HsState[4] {
		Status = HsState[5]
		fmt.Println(HsState[5])
		return HsState[5]
	}
	if MoveTo == "HS og korn til båt" && Status == HsState[6] {
		Status = HsState[5]
		fmt.Println(HsState[5])
		return HsState[5]
	}
